...
Projects proposed by mentors are listed at our [ideas list](2024/ideas-list.md).
...
You can use our [base template](https://github.com/open2c/gsoc/blob/main/templates/proposal.md) 
to get an idea about how to go about writing the proposal.
...
a PDF file. Your proposal name should start with *Open2C* to make
